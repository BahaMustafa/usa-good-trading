        ...
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="flex items-center">
              <div className="h-10 w-10 bg-blue-600 rounded-md flex items-center justify-center text-white font-bold text-lg shadow-sm group-hover:bg-blue-700 transition-colors">
                <span>USA</span>
              </div>
              <div className="ml-2 font-semibold text-gray-800 tracking-tight">
                <span className="text-lg">GOOD TRADING</span>
              </div>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link
              href="/products"
              className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${isActive('/products') 
                ? 'bg-blue-100 text-blue-700' 
                : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600'}`}
            >
              Products
            ...
            <Link
              href="/about"
              className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${isActive('/about') 
                ? 'bg-blue-100 text-blue-700' 
                : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600'}`}
            >
              About Us
            ...
            <Link
              href="/contact"
              className="ml-3 px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 transition-colors shadow-sm hover:shadow"
            >
              Contact Us
            </Link>
          </div>
