...
export default function Footer() {
  ...
  const popularCategories = [
    ...
    { name: 'JACKET', path: '/products?category=JACKET' },
    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-sm text-gray-500 mb-4">EST. 2004</p>
          <p className="text-gray-400 text-sm mb-6">
            A trusted wholesale clothing supplier since 2004.
          </p>
          <div className="mt-4">
            <h3 className="text-white font-semibold mb-2">Contact Us</h3>
            <p className="text-gray-400 text-sm">Email: bhaatobase93@gmail.com</p>
            <p className="text-gray-400 text-sm">Phone: (909) 687-6383</p>
          </div>
        </div>
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex flex-col space-y-4">
            {/* Facebook */}
            <a
              href="https://www.facebook.com/profile.php?id=61576227886192"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center text-gray-400 hover:text-white transition group"
            >
              <div className="bg-blue-600 p-2 rounded-full mr-3 group-hover:bg-blue-500 transition">
                <svg className="w-5 h-5 text-white" viewBox="0 0 320 512" fill="currentColor">
            ...
            {/* Instagram */}
            <a
              href="https://instagram.com/usagoodtrading"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center text-gray-400 hover:text-white transition group"
            >
              <div className="bg-gradient-to-tr from-yellow-500 via-pink-600 to-purple-700 p-2 rounded-full mr-3 group-hover:opacity-90 transition">
            ...
            {/* Twitter */}
            <a
              href="https://twitter.com/usagoodtrading"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center text-gray-400 hover:text-white transition group"
            >
              <div className="bg-blue-400 p-2 rounded-full mr-3 group-hover:bg-blue-500 transition">
